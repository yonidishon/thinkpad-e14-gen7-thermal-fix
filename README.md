...
**Also: kernel updated to 6.17.0-19-generic** (was 6.17.0-14). i915 PSR/DSB kernel parameters tested without on 6.17.0-19 — atomic update failures appeared, params are still required.
